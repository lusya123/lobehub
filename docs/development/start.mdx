...
In day-to-day work, Hono-Lite is enough: the main SPA, the auth SPA, and
the full API surface all work without Next. You only need the classic
mode when touching the SPA HTML template service or Next middleware
behavior.
